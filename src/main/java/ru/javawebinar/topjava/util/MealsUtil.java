...
public class MealsUtil {
    ...
    public static void main(String[] args) {
        ...
        List<MealTo> mealsWithExcess = getFilteredWithExcess(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), Calories.CALORIES_PER_DAY);
        mealsWithExcess.forEach(System.out::println);

        System.out.println(getFilteredWithExcessByCycle(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), Calories.CALORIES_PER_DAY));
        System.out.println(getFilteredWithExcessInOnePass(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), Calories.CALORIES_PER_DAY));
        System.out.println(getFilteredWithExcessInOnePass2(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), Calories.CALORIES_PER_DAY));
    }
